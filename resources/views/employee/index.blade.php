    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p><a class="btn btn-lg btn-outline-secondary" href="/employee/employers" role="button">Traži poslodavce</a></p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption d-none d-md-block">
                        <h1 class="homepageHeadings">Zanima te tko ti je konkurencija</h1>
                        <p class="homepageDescriptions">Provjeri i budi bolji od njih!</p>
