<div class="col-sm-3 offset-sm-1 blog-sidebar">
    <div class="sidebar-module sidebar-module-inset">
        <h4>Dobrodošli stranicu za pregled poslova</h4>
        <hr>
        <p>Ovdje možete vidjeti pojedinosti objavljenih poslova, te kontaktirati poslodavce za više informacija.
            Također, moguće je filtrirati ponuđene po poslove po vremenu objavljivanja, vremenu odvijanja te traženim
