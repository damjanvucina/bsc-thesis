    ...
    function addInput(divName) {
        if (counter == limit) {
            ...
            newdiv.innerHTML = "<div class='form-group'>" +
                "<div class='col-md-14'>" +
                "<input required id='language' type='text' class='form-control' name='languages[]' placeholder='Potrebno znanje jezika'>" +
                "</div>" +
                "</div>";
    ...
    function addInput1(divName1) {
        if (counter1 == limit1) {
            ...
            newdiv1.innerHTML = "<div class='form-group'>" +
                "<div class='col-md-14'>" +
                "<input required id='skill' type='text' class='form-control' name='skills[]' placeholder='Potrebno znanje tehnologija'>" +
                "</div>" +
                "</div>";
                    ...
                    <div class="r-form-1-bottom">
                        ...
                        <form role="form" method="POST" action="/jobs/create">
                            ...
                            <div class="form-group">
                                <input type="date" name="startdate" placeholder="  Datum početka"
                                       class="r-form-1-text form-control" id="startdate" title="Datum početka posla"
                                       required>
                            </div>

                            <div class="form-group">
                                <input type="date" name="enddate" placeholder="  Datum završetka"
                                       class="r-form-1-text form-control" id="enddate" title="Datum završetka posla"
                                       required>
                            </div>

                            <div class="form-group">
                                <select name="payment" id="payment" placeholder=" Način plaćanja"
                            ...
                            <div class="form-group">
                                <input type="number" name="salary" placeholder="  Plaća u HRK"
                            ...
                            <div class="form-group">
                                <select name="requiredexperience" id="requiredexperience"
                                        placeholder="  Iskustvo u navedenom tipu posla"
                                        class="r-form-1-text form-control" required>
                            ...
                            <div class="form-group">
                                <input type="text" name="description" placeholder="Kratak opis posla"
