        ...
        <div class="row">
            <div class="col-sm-8 blog-main">
                    ...
                    <div class="card-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"><p
                                        class="card-text">
                                {{\App\User::where('id', '=', $employer->id)->pluck('town_id')->first() }}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">Broj zaposlenika:</div>
                            <div class="col-md-4"></div>
                            <div class="col-md-4"><p
                                        class="card-text">
                        ...
                        <div class="row">
                            <div class="col-md-4">Broj poslova mjesečno:</div>
                            <div class="col-md-4"></div>
                            <div class="col-md-4"><p
                                        class="card-text">{{$employer->numjobs}}</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"><p
                                        ...
                                        ->where('reviewee', '=', $employer->id)->avg('grade'), 2)}}</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"><p
                                        ...
                                        ->where('reviewee', '=', $employer->id)->count()}}</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"><p
                                        class="card-text">
                                    {{\App\User::where('id', '=', $employer->id)->pluck('email')->first()}}
                                </p>
                            </div>
                        </div>
                        ...
                        @if(auth()->id()== $employer->id)
                            <a href="/employer/employers/edit/{{$employer->id}}" class="btn btn-outline-info">Uredi profil</a>
                            &nbsp;&nbsp;&nbsp
                            <a href="/employer/employers/delete/{{$employer->id}}" class="btn btn-outline-info">Obriši profil</a>
                        @endif
                ...
                <div class="form-group">
                    <input type="hidden" name="reviewee" id="reviewee" value="{{$employer->id}}">
                </div>

                <?php
                $evaluated = \DB::table('reviews')->where('reviewer', '=', auth()->id())
                    ->where('reviewee', '=', $employer->id)->count();
                ?>
                @if(auth()->user()->usertype=='employee' && $evaluated == 0)
                    <form method="post" action="/employee/employers/{employer}/reviews">
                ...
                <?php
                $reviews = \DB::table('reviews')->where('reviewee', '=', $employer->id)->latest()->get();
                ?>
                @foreach($reviews as $review )
                    ...
                    $name = \App\Employee::where('id', '=', $review->reviewer)->first()->name;
                    $surname = \App\Employee::where('id', '=', $review->reviewer)->first()->surname;
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-block">
                            ...
                            <h5 class="card-subtitle mb-2 text-muted"><span
                                        class="badge badge-default">{{$name . ' ' . $surname}}</span> </h5>
